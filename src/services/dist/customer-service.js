...
var UserService = /** @class */ (function () {
    function UserService() {
        var _this = this;
        this.signUpUser = function (userDetails) { return __awaiter(_this, void 0, void 0, function () {
            var userId;
            return __generator(this, function (_a) {
                try {
                    userId = this.auth.currentUser.uid;
                    return [2 /*return*/, this.db.collection("customers").doc(userId).set(userDetails)];
                }
                catch (error) {
        ...
        this.updateUserDetail = function (userDetails) { return __awaiter(_this, void 0, void 0, function () {
            var userId;
            return __generator(this, function (_a) {
                try {
                    userId = this.auth.currentUser.uid;
        ...
        this.getUserDetails = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    userId = this.auth.currentUser.uid;
                    return [2 /*return*/, this.db.collection("customers").doc(userId).get()];
                }
                catch (error) {
                    return [2 /*return*/, error];
                }
        ...
        this.db = base_1["default"].firestore();
    }
    return UserService;
}());
