...
import { primaryColor } from "../themes/theme-config";
...
const DisplayMoreProductDetails = (props: any) => {
  ...
  const [productsOnBasket, addProductToBasket] = useState<any>(
  ...
  const [productIsAdded, setProductIsAdded] = useState<any>(
    checkIfAlreadyAddedOnBasket(productDetails)
  );

  return (
    <div>
      <IconButton onClick={() => handleNavigation("/")} aria-label="show more">
        <ChevronLeft />
        back
      </IconButton>
      <Card className={classes.productDisplayRoot}>
        ...
        <div className={classes.details}>
          <CardContent className={classes.content}>
            ...
            <div>
              <Typography className={classes.contentDetails} component="p">
              ...
              >
                Added
                <ShoppingCart /> <div className={classes.divider}>|</div>
                <Button
