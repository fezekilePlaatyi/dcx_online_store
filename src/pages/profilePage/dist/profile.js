    ...
    return (react_1["default"].createElement("div", { className: classes.mainContainer },
        react_1["default"].createElement("div", { className: classes.boxWrapper },
            ...
            react_1["default"].createElement("form", { className: classes.form },
                ...
                react_1["default"].createElement("div", { className: classes.passwordBlock },
                    react_1["default"].createElement("div", { className: classes.whiteText }, "Change password"),
                    react_1["default"].createElement("div", { className: classes.textfieldBlockPassword },
                        react_1["default"].createElement(TextField_1["default"], { className: classes.textfield, autoComplete: "off", margin: "normal", label: "Old password", variant: "outlined", value: password, onChange: function (event) { return setPassword(event.target.value); }, required: true, InputProps: {
                                autoComplete: "off"
                            }, autoFocus: true }),
                        react_1["default"].createElement(TextField_1["default"], { className: classes.textfield, autoComplete: "off", margin: "normal", label: "New password", variant: "outlined", value: confirmPassword, onChange: function (event) { return setConfirmPassword(event.target.value); }, required: true, InputProps: {
                                autoComplete: "off"
                            }, autoFocus: true }),
                        react_1["default"].createElement(TextField_1["default"], { className: classes.textfield, autoComplete: "off", margin: "normal", label: "Confirm new password", variant: "outlined", value: confirmPassword, onChange: function (event) { return setConfirmPassword(event.target.value); }, required: true, InputProps: {
                                autoComplete: "off"
                            }, autoFocus: true }))),
                react_1["default"].createElement("div", { className: classes.buttonsContainer },
                    react_1["default"].createElement("div", { className: classes.loginButtonContainer },
                        react_1["default"].createElement(Button_1["default"], { className: classes.boxBtn, variant: "outlined", onClick: updateCustomer }, "SAVE"))),
